...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($result) {
        ...
        header("Location: students.php?info=edit_sucess");  // Redirect to list of students after success
        exit;
    } else {
        echo "Failed to update user!";
        header("Location: students.php?info=edit_failed");  // Redirect to list of students after success
...
<body>
    ...
    <div class="register-container">
        ...
        <form method="POST" action="#">
            ...
            <input type="text" name="username" value="<?= htmlspecialchars($userData['username']) ?>" hidden required>

            <input type="text" value="student" name="user_type" hidden required>
