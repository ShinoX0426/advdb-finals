...
<head>
    ...
    <title>Appointments View - Don Pablo Guidance Counseling</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .appointments-table { background-color: #fff; border-radius: 5px; box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1); padding: 20px; }
                    ...
                    <tbody>
                        <?php if (!empty($appointments)) : ?>
                            <?php foreach ($appointments as $appointment) : ?>
                                <tr>
                                    <td><?= htmlspecialchars($appointment['request_id']) ?></td>
                                    <td><?= htmlspecialchars($appointment['student_first_name'] . ' ' . $appointment['student_last_name']) ?></td>
                                    <td><?= htmlspecialchars($appointment['counselor_first_name'] . ' ' . $appointment['counselor_last_name']) ?></td>
                                    <td><?= htmlspecialchars($appointment['request_date']) ?></td>
